...
Yes, the column structure is the same four all four CSV files.
...
Democrats have a massive jump while the Republicans have a smaller jump in numbers. Unaffiliated and other rises significantly too. Also, the population has a big jump too.
...
There are 24 rows. There should be 24 rows.
...
It contains the population that is over 18 years old, the name of the county, and race including white, black, native, Asian, and pacific. Also, includes one_race and tow_more.
...
The county with the highest 18+ Black population as a percentage is Prince George's County at 60.90 percent. The percentage of Democrats in the county is 77.09 percent.
...
The highest 18+ Asian population is Howard County with 19.36 percent. The percentage of democrats in that county is 52.57 percent. The numbers tend to be smaller than the previous data set. Also, Howard and Montgomery have a much higher percentage than the rest of the counties. In the previous data set, the numbers were not all that far apart like this data set.
