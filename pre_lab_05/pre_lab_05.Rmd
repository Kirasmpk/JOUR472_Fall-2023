...
I problems that I see with this data are that there are only two pieces of data to go along with 10 categories of data that are listed.
...
The problem is similar to the answer above. Methods was added to this list of data, but even with method, I am not receiving all of the data points. Only three data points for 10 data sets.
...
We need to change the headers to real names so that R can read what we need.
