...
md_votes_data <- read.csv("md_votes_by_type.csv")

str(md_votes_data)

ggplot(md_votes_data, aes(x = as.factor(Year), fill = variable, y = value)) +
  geom_bar(position = "stack", stat = "identity") +
  labs(title = "Percentage of Votes by Type in Maryland (2018, 2020, 2022)",
       x = "Year",
       y = "Percentage of Votes") +
  scale_fill_manual(values = c("Early_Voting" = "blue", "Election_Day" = "red", "Mail" = "green")) +
  theme_minimal()
