...
I get 999 releases with the dates and URL for all of them. Along with that, I also get the title and text for all of these releases.
...
What's unique about this is is shows me when the words "Dog" and "cat" were used. Also, it doesn't consider "Dog" and "dog" to be the same word because of the capitalization of the word.
...
The output I get is 647,091 words and in the format I'm reading it in is word by word in order from top to bottom of the release but it's not together. Each word is in its own separate box.
...
The results that the graphic is showing is the count of unique words and how many times they were used in these releases. It's very interesting to see how many times these words were used in the releases but overall it is useless.
...
I believe that this is more interesting because rather than showing the number of times a word was used, we can see the percentage of times a word was used which gives me a slightly better idea how many times a word was used when comparing these words to each other.
...
The results show us the top 10 most used unique words used in the releases in the years 2021, 2022, and 2023 from 1-10.
...
The results show us the percentage of two-word phrases used the most in order from 1-10 in the year 2021. Also, the results show us the number of times these words were used. COVID-19 being first makes sense because that was during the height and beginning of COVID-19.
...
The results show us the percentage of two-word phrases used the most in order from 1-10 in the year 2022. Also, it shows us the number of times these words were used. COVID-19, Baltimore City, the Chesapeake Bay, human rights, and health care are all still in the top-10 a year later.
...
The results show us the percentage of two-word phrases used the most in order from 1-10 in the year 2023. Also, it shows us the number of times these words were used. COVID-19 fell out of the top-10, but the Chesapeake Bay, human rights, and health care are all still in the top-10 two years later. Human rights took the lead in the 2023 release.
...
When looking at the data I saw many of the words were either a positive or negative sentiment. For the most part I think that all of the words are categorized correctly expect for a handful of them.
