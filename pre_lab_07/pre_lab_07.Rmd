...
Nevada was the state with the largest percent growth with 35 percent.
...
Howard County was the county with the highest median household income in the state of Maryland.
...
It should say 2017-2021 Maryland County Survey.
...
No, the difference is not significant between the two counties.

Is the difference between Howard and everyone else significant?

**Answer**

Yes, the difference between Howard and everyone else is significant. Howard is up by 9,000 dollars compared to the next county in line. Everyone else is outside of their bar on the graph.
...
Baltimore City and Allegany County saw a 37 percent and 35 percent increase in median income. There were no counties that saw their median income fall.
...
One question that we could ask of this data is what is the race breakdown of each of the enrollment percentages. What might make the answer hard to interpret is the official number because the ACS can't fully count every person, especially ones who don't want to report their information.
...
More than 60% of high school graduates are enrolled and have an average income of 111,448.3 dollars. The count for this is 50. Less than 40% of high school graduates are enrolled and have an average income of 69,252.24 dollars. The count for this is 76.
...
We could ask this data about a specific ethnicity and the total count of how much money that ethnicity makes on average within this data set.
