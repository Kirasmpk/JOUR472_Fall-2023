...
**Answer** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url. <https://datawrapper.dwcdn.net/PHYBB/1/>
...
I can see various counties only in the state of Maryland. The information that is being showed is the FIPS-code.
...
**Task** Click the "Customize tooltips" button so it expands down. Change {{ fips_code }} to {{ county }} and {{ pctmoore }} to {{ FORMAT(pctmoore, "0.0%")}}

**Answer** Describe the changes from the previous map

I can now see the percentage of votes from each county and how many or how few of people voted for Moore within each county that is available to me.
...
<https://datawrapper.dwcdn.net/PQZUw/1/>
