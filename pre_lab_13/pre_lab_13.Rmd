...
I am seeing all of the 50 states and their population growth, chnge, and who each state voted for with the majority of their votes.
...
The pattern that I am seeing is most of the states gained in population and most grew in GDP, but some gained more and some gained less. There is a weak correlation in this scatter plot.
...
I am seeing that it is almost even in terms of the dots being above and below the line but this scatter plot is weaker than the previous one.
...
I am seeing that there's a slightly negative correlation in GDP growth and population change being -0.059. There is a positive correlation in GDP growth and population change for 2021 with 0.211.
...
I am seeing that there is a statistically significant increase in our pupil 2021 data. There is no correlation between the pupil and sample estimates. The data did not showing us a correlation between the expenditure per pupil and the population change.
...
I am seeing that if we spend more money pupil than population growth, we get a very weak, negative correlation between these things. This is not statically significant because we can not confidentially say that these two things are negatively correlated due to the numbers that were produced.
...
I am seeing that the mean GDP growth for Biden was 5.872, the mean_per_pupil for Biden was 16578.80 and then mean_pop_growth was 0.1768. For Trump I am seeing a 4.304 percent for mean_gdp_growth, 12378.88 for mean_per_pupil, and 0.5496 for mean_pop_growth. Biden grew in mean_gdp_growth and mean_per_pupil but Trump grew in mean_pop_growth.
...
I am seeing that the p-value is 0.07411 and that is not statistically significant.
...
I am seeing that the money spent per student is statistically significant.
